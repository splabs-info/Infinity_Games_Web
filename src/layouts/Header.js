                    ...
                    <PriceBox spacing={3} sx={{ display: scrollPositionToggle ? 'none' : 'block' }}>
                        ...
                        >
                            ...
                            >
                                ...
                                <Typography
                                    className={
                                        changeINGData?.percentChange > 0
                                            ? 'Up Change'
                                            : 'Down Change'
                                    }
                                    minWidth={70}
                                >
                                    {changeINGData?.percentChange ? (
                                        Math.abs(changeINGData?.percentChange)
                                    ) : (
                                        <CircularProgress size={15} color="primary" />
                                    )}
                                </Typography>
                            ...
                            >
                                <Typography color={Color.text} ml={2}>
                                    {' '}
                                    Buy On{' '}
                                </Typography>
