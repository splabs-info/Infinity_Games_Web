...
export const SettingReducer = (state = initialState, action) => {
  ...
  switch (type) {
    case SettingStoreConstant.SET_CONTRACT_LIST:
      return { ...state, contractList: payload };
    case SettingStoreConstant.SET_NATIVE_COIN_ADDRESS:
      return { ...state, nativeCoinAddress: payload };
