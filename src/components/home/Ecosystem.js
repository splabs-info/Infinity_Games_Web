...
import {
    contentEcosystem,
    gamesEcosystem,
    imgPartnersEcosystem,
    infinityAnglesImages,
    socialMembersEcosystem,
} from './Content';
import { ecosystemAngleSliderSettings, ecosystemSliderSettings } from './SliderSettings';
        ...
        >
            ...
            <Container>
                <TitleBox pb={isDesktop ? 5 : 2}>
                    <TypographyShadow variant="h3">Ecosystem</TypographyShadow>
                    ...
                    <Grid container>
                        <Grid item xs={12} md={7}>
                            <SliderCustom {...ecosystemAngleSliderSettings}>
                                {infinityAnglesImages.map((item, index) => (
                                    <img alt={item.label} src={item.src} key={index} />
                                ))}
                            </SliderCustom>
                            <Box
                                display="flex"
                            ...
                            >
                                {imgPartnersEcosystem.map((item, index) => (
                                    <img
                                        src={`/images/ecosystem/${item.label}.png`}
                                        alt={item.label}
                                        key={index}
                                        style={{ maxWidth: '25%' }}
                                    />
                        ...
                        <Grid item xs={12} md={5} pl={isDesktop && 4}>
                            <Box display="flex">
                                <Box width={'80%'} display="flex" mb={2}>
                                    <Box width={'30%'}>
                                        <img
                                            src={`/images/ecosystem/logo-square.jpg`}
                                            alt={''}
                                            style={{ borderRadius: '5px' }}
                                        />
                                    </Box>
                                    <Box width={'70%'} sx={{ color: 'white', paddingLeft: '1rem' }}>
                                        <Box
                                            sx={{
                                                padding: '0.5rem 1rem',
                                                borderRadius: '10px',
                                ...
                                <Box width={'20%'}>
                                    <img
                                        src={`/images/ecosystem/qr-code.jpg`}
                                        alt={''}
                                        style={{ borderRadius: '5px' }}
                                    />
                                </Box>
                ...
                <SliderCustom {...ecosystemSliderSettings}>
                    {gamesEcosystem.map((item, index) => (
                        <GameBox key={index}>
                            <Box component={'img'} alt="" src={item.src} />
                            <GameTextBox>
                ...
                <TitleBox pt={isDesktop ? 10 : 5}>
                    <TypographyShadow variant="h3">Guild Games</TypographyShadow>
                    <img alt="infinity" src="/images/home/line-1.png" />
                    <Typography
                        variant="p"
                        sx={{
                ...
                <TitleBox pt={isDesktop ? 5 : 2}>
                    <TypographyShadow variant="h3">Secured By</TypographyShadow>
                    <img alt="infinity" src="/images/home/line-1.png" />
                    <Box
                        sx={{
                            background: '#026B69',
                ...
                <TitleBox pt={isDesktop ? 5 : 2}>
                    <TypographyShadow variant="h3">Featured By</TypographyShadow>
                    <img alt="infinity" src="/images/home/line-1.png" />
                    <Stack direction="row" spacing={4} mt={4}>
                        ...
                        >
                            <img alt="" src="/images/partners/cointelegraph1.png" />
                        </Box>
                        <Box
                            sx={{
                                background: '#026B69',
                        ...
                        >
                            <img alt="" src="/images/partners/MK1.png" />
                        </Box>
                    </Stack>
                </TitleBox>
            </Container>
