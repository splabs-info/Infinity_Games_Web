...
import { AppButton, ApplyButton, ButtonTitleBox, TypographyOutline } from './HomeStyles';

const Title = ['Journey Games Web3', 'on the Multi-Chain!'];
const SubTitle = [
    ...
    return (
        ...
        >
            <Container maxWidth={'lg'} sx={{ minHeight: isTablet ? 'unset' : '85vh' }}>
                <Grid
                    container
                    sx={{ minHeight: isTablet ? 'unset' : '85vh', flexDirection: isTablet && 'column-reverse' }}
                >
                    <Grid
                        item
                        xs={12}
                    ...
                    >
                        ...
                        <ButtonTitleBox>
                            ...
                            <ApplyButton>
                                <img alt="infinity" src="/images/icon/icon-note.png" />
                                &nbsp;&nbsp;Contact us
                            </ApplyButton>
                        </ButtonTitleBox>
                    </Grid>
