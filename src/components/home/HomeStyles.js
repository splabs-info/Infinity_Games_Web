...
export const ApplyButton = styled(Button)(({ theme }) => ({
    ...
    '&:hover': {
        background: 'linear-gradient(270deg, #11ADA9 0%, #25CAC6 50%, #2AD8D3 100%)',
        color: 'white',
        transition: '0.5s, background 1s',
...
export const AppButton = styled(Button)(({ theme }) => ({
    position: 'relative',
    color: 'white',
    background: 'linear-gradient(45deg, #11ADA9 0%, #25CAC6 50%, #2AD8D3 100%)',
    transition: '0.5s,background 1s',
    '&:hover': {
        background: 'linear-gradient(270deg, #11ADA9 0%, #25CAC6 50%, #2AD8D3 100%)',
...
export const SignUpGrid = styled(Grid)(({ theme }) => ({
    ...
    '&::after': {
        ...
        borderRadius: '20px',
        padding: ' 2px',
        background: 'linear-gradient(to bottom, transparent 25%, #153851 70%)',
        WebkitMask:
            'linear-gradient(rgb(255, 255, 255) 0px, rgb(255, 255, 255) 0px) content-box content-box, linear-gradient(rgb(255, 255, 255) 0px, rgb(255, 255, 255) 0px)',
        WebkitMaskComposite: 'xor',
        zIndex: '1',
